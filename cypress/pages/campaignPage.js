...
export default class CampaignPage {
  constructor(campaign) {
    ...
    this.brand_safety = campaign.brand_safety ? campaign.brand_safety.brand_safety : null
    this.contextual_targeting = campaign.brand_safety ? campaign.brand_safety.contextual_targeting : null
  ...
  selectAdDomain() {
    cy.get(CAMPAIGN_CREATION.CAMPAIGN_AD_DOMAIN_SELECT).select(CONSTANTS.AD_DOMAIN[this.ad_domain], { force: true })
